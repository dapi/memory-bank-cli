...
- `EVID-01` Targeted test output and approved live upstream PR URL.
- `EVID-02` Targeted preflight/failure test output.
- `EVID-03` Targeted selection-fixture test output.
- `EVID-04` Targeted transaction/recovery test output and review record for any externally observable recovery.
- `EVID-05` Targeted dry-run test output.
