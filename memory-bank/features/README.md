...
- [FT-054: AI-Assisted, Human-Approved Pull Resolution](FT-054-ai-assisted-human-approved-pull-resolution/README.md) — blocked pending human approval of the authorization contract for issue #54's reviewable, human-approved pull resolution plans.
