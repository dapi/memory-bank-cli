...
| `SOL-03`–`SOL-04`, `SD-02`, `CTR-02`, `INV-02`–`INV-06`, `FM-01`–`FM-02` | apply validation, mechanical-merge derivation/recomputation and adapted/deterministic action resolution | `STEP-02` | `CHK-02`–`CHK-04` / `EVID-02`–`EVID-04` |
...
| `STEP-02` | either | `REQ-03`–`REQ-05`, `SOL-03`–`SOL-04`, `CTR-02`, `INV-*` | Add validated apply and action resolution, including an exclusive update guard, transaction-scoped final revalidation, verified base bytes, deterministic three-way merge recomputation, reviewed result/mode and deterministic keep-and-detach. | `internal/ownership`, CLI tests/E2E | `CHK-02`, `CHK-03` | `EVID-02`, `EVID-03` | `STEP-01`, `PRE-02` | human decision and valid authorization exist before apply; no runtime prompt required | an action, mechanical merge or final pre-commit state cannot be validated before staging |
| `STEP-03` | either | `REQ-03`, `REQ-07`, `SOL-04`, `FM-*` | Route valid results through the guarded atomic transaction and add stale/tamper/competing-writer/injected-failure E2E. | ownership transaction and regression tests | `CHK-04` | `EVID-04` | `STEP-02` | none | payload and lock cannot be proved unchanged after failure or a writer can interleave after final validation |
...
| `CP-03` | `STEP-03` | Stale/tampered/failed or competing-writer apply preserves all payload and lock state, with no validation-to-commit interleaving. | `EVID-04` |
