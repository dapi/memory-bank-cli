...
| `SOL-03`, `INV-02`, `FM-03`, `RB-01`–`RB-03` | `design.md` | documentation, release notes, tag/release verification | `STEP-03`, `STEP-04`, `STEP-05` | `CHK-03`–`CHK-05` | `EVID-03`–`EVID-05` |
...
| `STEP-03` | either | `REQ-03`, `REQ-04`, `SOL-03`, `INV-02` | add Go install/upgrade docs and breaking release notes | root README and release-note source/config | reviewable documentation | `CHK-05` | `EVID-05` | review exact install command and prohibited identity surface | none | none | docs require a compatibility path or contradict the issue |
