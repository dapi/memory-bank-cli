---
title: memory-bank-cli Use Cases Index
doc_kind: use_case
doc_function: index
purpose: "Реестр устойчивых пользовательских и operational scenarios memory-bank-cli."
derived_from:
...
| UC ID | Title | Annotation | Status | Primary actor | Upstream PRD | Implemented by |
| --- | --- | --- | --- | --- | --- | --- |
