...
scenario_15() { setup_case E2E-15; init_v1; rm "$(file memory-bank/dna/managed.md)"; ln -s "$case_root/outside" "$(file memory-bank/dna/managed.md)"; checkout_v2; snapshot; expect_fail update_v2; assert_unchanged; }
